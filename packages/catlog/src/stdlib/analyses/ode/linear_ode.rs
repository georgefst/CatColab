...
// TODO check that the above comment is still true
...
mod test {
    ...
    fn neg_loops_pos_connector_from_model() -> ODEProblem<NumericalPolynomialSystem<u8>> {
    ...
    #[test]
    fn matrix_agrees_with_categorical() {
        assert_eq!(neg_loops_pos_connector_from_model(), neg_loops_pos_connector_from_matrix());
    }
